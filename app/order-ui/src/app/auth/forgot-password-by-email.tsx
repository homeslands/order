...
export default function ForgotPasswordByEmail() {
    ...
    const handleVerifyOTP = () => {
        verifyOTPForgotPassword({ email: email, verificationMethod: VerificationMethod.EMAIL, code: otpValue }, {
            onSuccess: (response) => {
    ...
    const handleResendOTP = () => {
        resendForgotPassword({ email: email, verificationMethod: VerificationMethod.EMAIL }, {
            onSuccess: () => {
                showToast(tToast('toast.sendVerifyEmailSuccess'))
            }
        })
    ...
    return (
        <div className="relative flex items-center justify-center min-h-screen">
            ...
            <div className="relative z-10 flex items-center justify-center w-full h-full">
                <Card className="sm:min-w-[28rem] flex flex-col gap-4 justify-center items-center bg-white border border-muted-foreground bg-opacity-10 shadow-xl backdrop-blur-xl">
                    <CardHeader>

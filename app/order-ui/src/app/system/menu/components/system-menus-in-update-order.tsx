        ...
        <div key={index} className='flex flex-col gap-4 mt-4'>
          ...
          <div className='grid grid-cols-1 gap-4 w-full sm:grid-cols-2 lg:grid-cols-3'>
            {group.items.map((item) => (
              <div
                key={item.slug}
                className="flex flex-row sm:flex-col justify-between rounded-xl bg-white border border-muted-foreground/40 transition-all duration-300 ease-in-out min-h-[8rem] sm:min-h-[16rem] dark:bg-transparent hover:shadow-lg"
              >
                <div
